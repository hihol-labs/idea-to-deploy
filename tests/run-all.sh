...
CORE="meta_review verify_triggers verify_gate_taxonomy verify_registration_and_counts verify_hook_table_completeness verify_host_adapters verify_cross_platform_runtime verify_session_hygiene_quality verify_live_model_benchmark verify_harness_conformance verify_practical_effectiveness verify_operational_cold_start verify_operational_continuation verify_bypass_friction verify_learning_loop verify_external_outcome_contract verify_external_pilot_collection verify_graduated_trust verify_all_hard_gate_host_parity verify_host_neutral_memory verify_fresh_session_resume verify_strict_completion_policy verify_completion_policy_calibration verify_observed_token_telemetry verify_efficiency_attribution verify_proportionality_benchmark verify_work_deadline_contract verify_work_deadline_runtime verify_verification_profiles verify_verification_loop verify_api_reviewer verify_external_reviewer_release verify_review_broker_policy verify_review_broker_primitives verify_review_broker verify_review_broker_server verify_review_broker_operator verify_review_broker_deployment verify_github_app_manifest verify_machine_oracle verify_gate_control verify_itd_cli verify_git_gate_hooks verify_external_write_gate verify_model_risk_monotonic verify_model_policy_hint verify_work_deadline_docs verify_control_quality verify_harness_docs_freshness verify_harness_engineering_improvements"
...
verify_otel_export \
verify_platform_tmp_and_new_hooks verify_goal_tools verify_goal_bounded_autonomy verify_goal_five_star verify_retro_scan verify_completion_adversarial_corpus \
