...
verify_otel_export \
verify_platform_tmp_and_new_hooks verify_ledger_reconciliation verify_route_metric verify_goal_bounded_autonomy verify_goal_five_star verify_retro_scan verify_completion_adversarial_corpus \
...
verify_unit_log verify_goal_verify_shell verify_risk_tier_default verify_tier_source verify_preflight_budget verify_hook_tier_exit verify_hooks_autoinstall \
