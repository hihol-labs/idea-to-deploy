...
вхождениями МЕНЯЛСЯ КАНДИДАТ. Личность кандидата выводится из участков диффа
внутри записанной улики, а не из улики целиком: обёртка промпта меняется от
правок маршрута, и неизменный кандидат выглядел бы изменившимся. два независимых ревью одного и того же
