...
| F-06 | Mandatory provider-neutral keyless independent checker (OpenAI → Anthropic → Gemini) | adopt | `docs/adr/ADR-004-mandatory-keyless-review-route.md` | Typed `UNAVAILABLE` after ordered exhaustion; required acceptance remains `UNVERIFIED` until Verification Loop gets eligible evidence |
