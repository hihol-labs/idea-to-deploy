...
| F-06 | Mandatory provider-neutral cross-review entry point selecting one fresh opposite-GPT checker (Sol → Terra / Terra → Sol) | adopt | `docs/adr/ADR-006-single-opposite-gpt-review.md` | No automatic provider fallback; required acceptance remains `UNVERIFIED` until evidence-first Verification Loop gets eligible exact-candidate evidence |
