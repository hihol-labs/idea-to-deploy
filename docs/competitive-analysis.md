...
- **Отдельный файл `EXAMPLES.md` с anti-patterns** — 40 скиллов × 2 примера = ~1000 строк документации с риском drift. Существующие in-skill examples + trigger phrases покрывают кейсы лучше.
