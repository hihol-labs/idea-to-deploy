...
- **Messaging:** "136 скиллов без роутера = cognitive overload. 25 скиллов с /task = правильный скилл за 10 секунд"
...
- **Отдельный файл `EXAMPLES.md` с anti-patterns** — 27 скиллов × 2 примера = ~1000 строк документации с риском drift. Существующие in-skill examples + trigger phrases покрывают кейсы лучше.
