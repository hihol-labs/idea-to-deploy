...
> Актуальность: **2026-07-21**, idea-to-deploy **v1.92.0**.
...
| # | Принцип курса | Статус | Реализация в idea-to-deploy (v1.92.0) | Evidence / комментарий |
|---|---|:---:|---|---|
