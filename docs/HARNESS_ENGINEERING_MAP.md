...
| `state-guard.sh` | PreToolUse + PostToolUse (Write/Edit, Bash) | guardrail + feedback | computational | **blocking** — deny записи леджера при чужом свежем локе (single-writer, ≤2 deny, v1.76.0); soft-ноги — валидация после записи/Bash-мутации + heartbeat лока (v1.75.0) |
