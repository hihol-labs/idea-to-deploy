...
> Исполняемая evidence-база получена для v1.91.0 на 2026-07-16 и перенесена
> без расширения claims: v1.91.1 меняет только публичное позиционирование и
> release metadata, а не contracts, hooks, skills или adapter behavior. Оценка
> действительна только пока проходят замороженный evaluator,
> freshness-проверки и полный regression suite.
