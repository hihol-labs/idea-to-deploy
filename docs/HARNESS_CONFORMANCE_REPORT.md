...
> **Результат: 5,0/5,0.** Оценка относится к idea-to-deploy **v1.90.0**
> на 2026-07-15 и действительна только пока проходят замороженный evaluator,
...
Практическая сила архитектуры — разделение **10 hard gates** и **19 soft
