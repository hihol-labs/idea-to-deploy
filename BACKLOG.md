...
- [x] **Оценщик завершения приклеивает evidence к произвольной команде —
  ...
  оракул 15 -> 78 (43 на закрытии A2; +8 в hd-раундах cross-vendor ревью: heredoc-терминаторы, двойной heredoc, here-string; +3 PUB4: общий класс слов-делимитеров).** Исходный текст:
