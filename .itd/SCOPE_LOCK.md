...
- `tests/verify_verification_profiles.py` — оракул пункта (57 -> 104 проверок):
  ...
  воспроизведён живым тестом до правки). Оракул 86 -> 104 (пять escape-проверок; мутантные карты пишутся внутрь root во
