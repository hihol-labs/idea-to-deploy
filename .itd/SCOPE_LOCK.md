...
- deterministic hierarchical API review and aggregate budget/evidence binding
...
- allowing CLI/OAuth reviewers, a caller-supplied status, `neutral`, `skipped`,
  API outage, zero balance, stale SHA/base, over-limit or incompletely reviewed
  input, unknown maker, or
