...
- `tests/verify_verification_profiles.py` — оракул пункта (57 -> 105 проверок):
  ...
  существующий файл рабочего дерева. Оракул 86 -> 105 (пять escape-проверок; мутантные карты пишутся внутрь root во
