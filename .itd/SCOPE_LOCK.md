...
- **LPD002-A2 (стейл-оценщик completion-гейта)** — `hooks/completion_lib.py`:
  ...
  `tests/verify_completion_signal_classes.py` (15 -> 78 проверок, RED-first —
...
- **LPD002-A8 (процедура authority-снапшота)** — раздел в
  ...
  PUB4/PUB5/PUB6/PUB7/envelope-регрессий фактическое значение — 78, все
  места обновлены вместе.
