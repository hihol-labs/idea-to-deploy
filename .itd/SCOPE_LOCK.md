...
## Результат
Релиз опубликован: PR #245 -> merge `24698e2`, тег `v1.101.0`. Раскатка
подтверждена хешами на четырёх целях (один runtime `1.101.0-6ba753846c92ffba`).
`/retro` записан в `docs/retros/RETRO-2026-08-29.md`; кандидаты P1-P8 переданы
владельцу и в BACKLOG НЕ заведены.
